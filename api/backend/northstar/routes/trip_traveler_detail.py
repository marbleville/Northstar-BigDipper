...
@trip_traveler_bp.route("/trips/<int:trip_id>/travelers/<int:traveler_id>", methods=["GET"])
...
@trip_traveler_bp.route("/trips/<int:trip_id>/travelers/<int:traveler_id>", methods=["PUT"])
